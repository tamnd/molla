...
which knows what a model does. Nothing here knows about attention or about
tokens. It knows how a quantized block is laid out, what a tensor's shape and
stride are, and how to multiply two of them.
