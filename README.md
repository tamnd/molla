...
| A Jinja2 subset for chat templates | no template engine, done, same bytes as Python `jinja2` over 38 real chat templates and 342 renders, every excluded construct refused at model load time, see [docs/validation/jinja.md](docs/validation/jinja.md) |
