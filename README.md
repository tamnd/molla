...
| GGUF and safetensors readers | GGUF metadata, tensor directory and the mapping to a model spec done, checked against llama.cpp, no tensor reads, no safetensors, see [docs/validation/gguf.md](docs/validation/gguf.md) and [docs/validation/spec.md](docs/validation/spec.md) |
